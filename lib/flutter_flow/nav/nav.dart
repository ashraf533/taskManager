...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? GeminiAIWidget() : LetsStartWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: ProfessionsWidget.routeName,
          path: ProfessionsWidget.routePath,
        ...
        FFRoute(
          name: LetsStartWidget.routeName,
          path: LetsStartWidget.routePath,
          builder: (context, params) => LetsStartWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => AddTaskWidget(
            taskRef: params.getParam<GetAllTasksRow>(
              'taskRef',
              ParamType.SqliteRow,
            ),
            taskRefOnGroup: params.getParam<GetAllTasksbasedOnGroupRow>(
              'taskRefOnGroup',
              ParamType.SqliteRow,
            ),
            taskRefOnStatus: params.getParam<GetAllTasksbasedOnStatusRow>(
              'taskRefOnStatus',
              ParamType.SqliteRow,
            ),
            taskRefOnSinglrGroupTask:
                params.getParam<GetAllSingleGroupTasksRow>(
              'taskRefOnSinglrGroupTask',
              ParamType.SqliteRow,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => ToDoTaskWidget(
            choiceChipInitial: params.getParam(
              'choiceChipInitial',
              ParamType.String,
            ),
          ),
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Android_Large_-_8.gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
